...
const EditClientProfile = ({ match, editClient, getClientProfile, profile: { clientProfile, loading } }) => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      pastInjuries: loading || !clientProfile.clientInjuries.pastInjuries ? '' : clientProfile.clientInjuries[0].pastInjuries,
      currentInjuries: loading || !clientProfile.clientInjuries.currentInjuries ? '' : clientProfile.clientInjuries[0].currentInjuries,
      longTermGoals: loading || !clientProfile.clientGoals.longTermGoals ? '' : clientProfile.clientGoals[0].longTermGoals,
      shortTermGoals: loading || !clientProfile.clientGoals.shortTermGoals ? '' : clientProfile.clientGoals[0].shortTermGoals,
